...
import pages.smartbear_pages.SmartBearViewAllOrdersPage;
...
public class SBOrder_StepDefs {
    ...
    SmartBearLandingPage sbLandingPage = new SmartBearLandingPage();
    SmartBearOrderPage sbOrderPage = new SmartBearOrderPage();
    SmartBearViewAllOrdersPage sbViewAllOrdersPage = new SmartBearViewAllOrdersPage();
    ...
    public void user_verifies_is_in_the_table(String givenName) throws InterruptedException {
        sbViewAllOrdersPage.allOrdersLink.click();
        Thread.sleep(3000);
